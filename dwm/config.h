...
static const Key keys[] = {
	...
	{ MODKEY|ALTKEY,                XK_u,                  incrgaps,       {.i = +5 } },                                     // adjust gaps MOD+ALT+u
	{ MODKEY|ALTKEY|ShiftMask,      XK_u,                  incrgaps,       {.i = -5 } },                                     // adjust gaps MOD+ALT+U
	...
	{ MODKEY|ALTKEY,                XK_3,                  setlayout,      {.v = &layouts[2]} },                              // change layout to spiral MOD+ALT+3
	...
	{ MODKEY|ALTKEY,                XK_7,                  setlayout,      {.v = &layouts[1]} },                              // change layout to monocle MOD+ALT+7
	...
	{ 0, XF86XK_MonBrightnessUp, spawn, {.v = brightness_up } },                                                              // fn + f8 to inc brightness
	{ 0, XF86XK_MonBrightnessDown, spawn, {.v = brightness_down } },                                                          // fn + f7 to dec brightness

	{ 0,                       XF86XK_AudioLowerVolume, spawn, {.v = downvol } },                                             // volume controls for pulseaudio
	{ 0,                       XF86XK_AudioMute, spawn, {.v = mutevol } },
	{ 0,                       XF86XK_AudioRaiseVolume, spawn, {.v = upvol   } },
	

	/*
	{ MODKEY,                       XK_Up,    spawn,          SHCMD("/home/nihar/dwm_fork/kbd-brightness/cycle-brightness.sh") },                         // MOD + up to increase keyboard brightness
	{ MODKEY,                       XK_Down,  spawn,          SHCMD("/home/nihar/dwm_fork/kbd-brightness/cycle-brightness.sh") },
	// MOD + down to decrease keyboard brightness
	*/
};
